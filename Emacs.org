...
Instead of using the package.el manager that is typically used, I opted to use [[https://github.com/raxod502/straight.el][straight.el]] to manage my packages because it directly downloads the repos from github and brings them to my system where I can make any edits if I desire.
